                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                ...
                                >
                                    <span
                                        className="group-hover:translate-x-1 transition-transform duration-200">Speakers</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    <span
                                        className="group-hover:translate-x-1 transition-transform duration-200">Schedule</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    <span
                                        className="group-hover:translate-x-1 transition-transform duration-200">Organizers</span>
                                </a>
                            </li>
                        </ul>
                    </div>
