        ...
        <SectionWrapper id="about" theme="blue-tint">
            <div className="text-center mb-16 animate-fade-in-up">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                    {siteConfig.eventTitle} is more than just a conferenceu2014it's a movement. We're building a
                    vibrant technology community, where developers of all levels come together to learn,
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="card-hover bg-card p-8 rounded-xl shadow-md text-center">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        Network with fellow technology enthusiasts, make lasting connections, and find your tribe
                ...
                <div className="card-hover bg-card p-8 rounded-xl shadow-md text-center">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        your technical skills through hands-on workshops.
                    </p>
                </div>
            ...
            <div className="mt-16 bg-primary/5 border border-primary/10 rounded-2xl p-8 sm:p-12">
                ...
                <p className="text-lg text-muted-foreground text-center max-w-4xl mx-auto leading-relaxed">
                    To empower the technology community by creating inclusive spaces for learning,
                    collaboration, and innovation. We believe in the power of community-driven growth and
                    are committed to making technology accessible to everyoneu2014from curious beginners to
