...
export const EventDetailsSection = () => {
    ...
    return (
      <section id="event-details"
               className="section-padding relative overflow-hidden bg-gradient-to-b from-secondary/5 to-background">
                              ...
                              >
                                  <div className="flex items-start gap-4">
                                      ...
                                      <div
                                          ...
                                          {item.title.includes("Networking") && <Users className="w-6 h-6 text-white"/>}
                                      </div>
