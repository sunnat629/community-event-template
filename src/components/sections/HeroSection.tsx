    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                ...
                <div
                    className="absolute bottom-20 right-10 w-96 h-96 bg-primary-light/20 rounded-full blur-3xl animate-float"
                    ...
                    <div className="animate-fade-in-up space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center pt-8">
                            {heroContent.buttons.map((button, index) => {
                                // Check if this is the GitHub contribute button
                                const isGitHubButton = button.text === "Contribute on GitHub";

                                return isGitHubButton ? (
                                    <a
                                        key={index}
                                        href={githubUrl}
                                        target="_blank"
                                    ...
                                    >
                                        <Button
                                            ...
                                            size="lg"
                                            className="text-lg px-10 py-7 h-auto min-w-[200px] font-semibold shadow-2xl hover:shadow-glow-lg transition-all duration-300 hover:scale-105 flex items-center"
                                        >
